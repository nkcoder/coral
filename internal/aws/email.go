...
// SendEmailWithAttachmentContent sends an email with an in-memory attachment using AWS SES
func SendEmailWithAttachmentContent(sender, recipient, subject, body, attachmentName string, attachmentContent []byte) error {
	// Create a buffer for the message
	var buf bytes.Buffer
